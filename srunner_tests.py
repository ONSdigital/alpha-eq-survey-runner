...
class SrunnerTestCase(unittest.TestCase):
    ...
    def test_questionnaire_render(self):
        FORM_SCHEMA = '{"overview": "This is a questionnaire to test stuff", "questionnaire_title": "Hope", "questions": [{"questionType": "InputText", "questionHelp": "All sizes count, even grandfathers.", "questionError": "Sorry - that doesn\'t look like a valid entry.", "questionText": "How many marbles do you have?"}]}'
